...
\begin{subfigure}
    \centering
    \includegraphics[scale=0.40]{TESI DI FIORE/img/roc_id_00.png}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[scale=0.40]{TESI DI FIORE/img/roc_id_02.png}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[scale=0.40]{TESI DI FIORE/img/roc_id_04.png}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[scale=0.40]{TESI DI FIORE/img/roc_id_06.png}
\end{subfigure}
\begin{subfigure}
    \centering
    \includegraphics[scale=0.40]{TESI DI FIORE/img/roc_complessive.png}
\end{subfigure}
