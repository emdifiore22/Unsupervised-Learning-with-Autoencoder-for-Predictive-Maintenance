...
\begin{figure}[ht]
\includegraphics[scale=0.65]{TESI DI FIORE/img/IDCCAE.png}
\centering
...
\begin{figure}[ht]
\includegraphics[scale=0.5]{TESI DI FIORE/img/LSTM-AE.png}
\centering
